...
# vi_mode settings
POWERLEVEL9K_VI_INSERT_MODE_BACKGROUND='grey'
POWERLEVEL9K_VI_INSERT_MODE_FOREGROUND='yellow'
POWERLEVEL9K_VI_INSERT_MODE_STRING="[INS]"
POWERLEVEL9K_VI_COMMAND_MODE_BACKGROUND='grey'
POWERLEVEL9K_VI_COMMAND_MODE_FOREGROUND='red'
POWERLEVEL9K_VI_COMMAND_MODE_STRING="[CMD]"
POWERLEVEL9K_VI_SEARCH_MODE_BACKGROUND='grey'
POWERLEVEL9K_VI_SEARCH_MODE_FOREGROUND='red'
POWERLEVEL9K_VI_SEARCH_MODE_STRING="[SRCH]"
POWERLEVEL9K_VI_VISUAL_MODE_BACKGROUND='grey'
POWERLEVEL9K_VI_VISUAL_MODE_FOREGROUND='red'
