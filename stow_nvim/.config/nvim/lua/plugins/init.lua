return {
    ...
    },
    {
        ...
        keys = {
            ...
            { "<leader>!f", function() Snacks.terminal.toggle(nil, { win = { position = "float" } }) end, desc = "Float Terminal" },
            { "<leader>!h", function() Snacks.terminal.toggle(nil, { win = { position = "bottom" } }) end, desc = "Horizontal Terminal" },
            { "<leader>!v", function() Snacks.terminal.toggle(nil, { win = { position = "right" } }) end, desc = "Vertical Terminal" },
        },
    },
    {
